...
public class User 
{
	...
	private List<Realty> savedRealtyList;
	...
	public User(String name, String mail, String password, UserType type, List<Realty> realtyList,
			List<Realty> favoriteRealtyList, List<Realty> savedRealtyList, List<Message> messages, LocalDateTime createDate) 
	{
		...
		this.savedRealtyList = savedRealtyList;
	...
	public List<Realty> getSavedRealtyList() {
		return savedRealtyList;
	}

	public void setSavedRealtyList(List<Realty> savedRealtyList) {
		this.savedRealtyList = savedRealtyList;
	}
	...
	public String toString() {
		return "User [name=" + name + ", mail=" + mail + ", type=" + type + "]";
	}
